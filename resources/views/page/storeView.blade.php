  ...
  <div class="col-md-5">
    ...
    <div class="panel panel-default">
      <div class="panel-body">
        <friend :profile_user_id="{{$page->user->id}}"></friend>
      </div>
    </div>
    @endif
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <p class="text-muted">
          Full Name: {{$page->user->fullname}}<br>
          Nic Name: {{$page->user->nicname}}
        </p>
        <hr>
        ...
        <p class="text-muted">Dictrict: {{$page->name}} - Post Code: {{$page->name}}</p>
        <hr>
