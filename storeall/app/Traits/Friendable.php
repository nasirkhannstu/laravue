...
trait Friendable{
	public function add_friend($user_requested_id){
		...
		if($this->has_panding_friend_request_to($user_requested_id) === 1){
			return "Already sent a friend request.";
		}
		if($this->has_panding_friend_request_from($user_requested_id) === 1){
	...
	public function accept_friend($requester){
		if($this->has_panding_friend_request_from($requester) === 0){
			return 0;
		}
	...
	public function has_panding_friend_request_from($user_id){
	...
	public function has_panding_friend_request_to($user_id){
